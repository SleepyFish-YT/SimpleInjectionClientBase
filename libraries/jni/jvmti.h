...
struct jvmtiTimerInfo {
    jlong max_value;
    jbool may_skip_forward;
    jbool may_skip_backward;
    jvmtiTimerKind kind;
    jlong reserved1;
    jlong reserved2;
};
...
typedef struct jvmtiInterface_1_ {
  ...
  /*   2 : Set Event NotificationClazz Mode */
  ...
  jvmtiError (JNICALL *IsInterface) (jvmtiEnv* env,
                                     jclass klass,
                                     jbool* is_interface_ptr);

  /*   56 : Is Array Class */
  jvmtiError (JNICALL *IsArrayClass) (jvmtiEnv* env,
                                      jclass klass,
                                      jbool* is_array_class_ptr);
  ...
  jvmtiError (JNICALL *IsModifiableModule) (jvmtiEnv* env,
                                            jobject module,
                                            jbool* is_modifiable_module_ptr);
