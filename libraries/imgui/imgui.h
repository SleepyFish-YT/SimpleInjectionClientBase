...
#define IMGUI_VERSION               "1.89.4 WIP - Sleepy Edit"
...
typedef unsigned int        ImColor32;
...
namespace ImGui
{
    ...
    IMGUI_API void          PushStyleColor(ImGuiCol idx, ImColor32 col);
    ...
    IMGUI_API ImColor32         GetImColor32(ImGuiCol idx, float alpha_mul = 1.0F);
    IMGUI_API ImColor32         GetImColor32(const ImVec4& col);
    IMGUI_API ImColor32         GetImColor32(ImColor32 col);
    ...
    IMGUI_API ImVec2        GetOffsetPos();
    IMGUI_API float         GetOffsetX();
    IMGUI_API float         GetOffsetY();
    IMGUI_API void          SetOffset(const ImVec2& local_pos);
    IMGUI_API void          SetOffset(float local_x, float local_y);
    IMGUI_API void          SetOffsetX(float local_x);
    ...
    IMGUI_API void          Text(const char *fmt, const ImVec4& col, ...)                   IM_FMTARGS(2);
    IMGUI_API void          TextButton(const char *fmt, bool* enabled, const ImVec4& col, ...) IM_FMTARGS(2);
    ...
    IMGUI_API bool          ButtonSleepy(const char *label, const ImVec2& size = ImVec2(0, 0), const ImVec2& size2 = ImVec2(10, 10), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ButtonSleepyRight(const char *label, const ImVec2& size = ImVec2(0, 0), const ImVec2& size2 = ImVec2(10, 10), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          Combo(const char *label, int* current_item, const char *items_separated_by_zeros, int popup_max_height_in_items = -1);      // Separate items with \0
    ...
    IMGUI_API bool          SliderDouble(const char *label, double* v, double v_min, double v_max, const char *format = "%.3f", float xposRemove = 0.0F, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderFloatMultiPosition(const char *label, ImVec2 pos1, ImVec2 pos2, double* v, double v_min, double v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalar2(const char *label, ImGuiDataType data_type, float xposRemove, void* p_data, const void* p_min, const void* p_max, const char *format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalarMultiposition(const char *label, ImVec2 pos1, ImVec2 pos2, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char *format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          SliderScalarN(const char *label, ImGuiDataType data_type, void* p_data, int components, const void* p_min, const void* p_max, const char *format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderFloat(const char *label, const ImVec2& size, float* v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderFloatSleepy(const char *label, const ImVec2& size, const ImVec2& size2, float* v, float v_min, float v_max, const char *format = "%.3f", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderInt(const char *label, const ImVec2& size, int* v, int v_min, int v_max, const char *format = "%d", ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderScalar(const char *label, const ImVec2& size, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char *format = NULL, ImGuiSliderFlags flags = 0);
    IMGUI_API bool          VSliderScalarSleepy(const char *label, const ImVec2& size, const ImVec2& size2, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char *format = NULL, ImGuiSliderFlags flags = 0);
    ...
    IMGUI_API ImVec4        ColorPickerSmellonNoButton(const char *name, float color[4], bool renderName, ImGuiColorEditFlags flags = 0);
    ...
    IMGUI_API bool          CollapsingHeader(const char *label, bool* p_visible, ImGuiTreeNodeFlags flags = 0); // when 'p_visible != NULL': if '*p_visible==true' display an additional sma
    ...
    IMGUI_API void                  TableSetBgColor(ImGuiTableBgTarget target, ImColor32 color, int column_n = -1);
    ...
    IMGUI_API ImColor       getRainbow(float frequency, float brightness, float gamma, float alpha, float offset = 0);
} // namespace ImGui
...
enum ImGuiColorEditFlags_ {
    ...
    ImGuiColorEditFlags_NoRightClick    = 1 << 29,
...
#else
MGUI_OVERRIDE_DRAWVERT_STRUCT_LAYOUT;
#endif
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRect(const ImVec2& p_min, const ImVec2& p_max, ImColor32 col, float gui_rounding = 0.0f, ImDrawFlags flags = 0, float thickness = 1.0F);
    IMGUI_API void  AddRectFilled(const ImVec2& p_min, const ImVec2& p_max, ImColor32 col, float gui_rounding = 0.0f, ImDrawFlags flags = 0);
    ...
    IMGUI_API void  AddText(const ImVec2& pos, ImColor32 col, const char *text_begin, float text_size, const char *text_end = NULL);
    IMGUI_API void  AddTextSleepy(const char *text_begin, const ImVec2& pos, ImColor32 col);
    IMGUI_API void  AddTextSleepyCustomSize(const char *text_begin, float size, const ImVec2& pos, ImColor32 col);
    IMGUI_API void  AddTextSleepyRainbow(const char *text_begin, const ImVec2& pos, float frequency, float brightness, float gamma, float alpha);
    ...
    IMGUI_API void  AddTextRainbow(const ImFont* font, float font_size, const ImVec2& pos, float frequency, float brightness, float gamma, float alpha, const char *text_begin, const char *text_end = NULL, float wrap_width = 0.0f, const ImVec4* cpu_fine_clip_rect = NULL);
    ...
    IMGUI_API void  PrimRect(const ImVec2& a, const ImVec2& b, ImColor32 col);
    ...
    inline    void  PrimVtx(const ImVec2& pos, const ImVec2& uv, ImColor32 col)         { PrimWriteIdx((ImDrawIdx)_VtxCurrentIdx); PrimWriteVtx(pos, uv, col); }
#ifndef IMGUI_DISABLE_OBSOLETE_FUNCTIONS
    inline    void  AddBezierCurve(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, ImColor32 col, float thickness, int num_segments = 0) { AddBezierCubic(p1, p2, p3, p4, col, thickness, num_segments); }
...
struct ImFont
{
    ...
    IMGUI_API ImVec2            CalcTextSizeAbyssCustomSize(const char *text_begin, float size); // utf8
    ...
    IMGUI_API void              RenderTextRainbow(ImDrawList* draw_list, float size, const ImVec2& pos, float frequency, float brightness, float gamma, float alpha, const ImVec4& clip_rect, const char *text_begin, const char *text_end, float wrap_width = 0.0f, bool cpu_fine_clip = false) const;
